        ...
        <div className="wrapper">
            <div className="sidebar-wrapper">
                <div className="profile-container">
                    <img className="profile" src={bilgi.image} alt="" width="100px" height="100px" />
                ...
                <div className="contact-container container-block">
                    <ul className="list-unstyled contact-list">
                        ...
                        <li className="phone"><i className="fa fa-phone"></i><a href={"tel:" + bilgi.phone}>{bilgi.phone}</a></li>

                        <li className="twitter"><i className="fa fa-twitter"></i><a href={bilgi.twitterURL} target="_blank">{bilgi.twitter}</a></li>
                    </ul>
                </div>
